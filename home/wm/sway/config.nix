...
in
{
  ...
  wayland.windowManager.sway = {
    ...
    extraConfig = ''
      ...
      #----------------------------------------#
      client.focused          ${h n.nord10} ${h n.nord10} ${h n.nord6}
      client.unfocused        ${h n.nord0} ${h n.nord1} ${h n.nord3}
      client.focused_inactive ${h n.nord0} ${h n.nord1} ${h n.nord3}
      client.placeholder      ${h n.nord0} ${h n.nord1} ${h n.nord3}
      client.urgent           ${h n.nord12} ${h n.nord12} ${h n.nord6}
      client.background       ${h n.nord0}
      ...
      bindsym $mod+Shift+d exec kitty --class="danmufloat" --hold sh -c "export TERM=xterm-256color && bili-live-tui --no-danmaku-color"
      bindsym $mod+Shift+x exec --no-startup-id        ${myswaylock}/bin/myswaylock
      bindsym $mod+t exec --no-startup-id              Telegram
      bindsym $mod+bracketleft  exec --no-startup-id   grimshot --notify savecopy anything ~/Pictures/$(date "+%Y-%m-%d"T"%H_%M_%S_no_watermark").png
