      ...
      userChrome = ''
        ...
        * {
        ...
        #sidebar-header *:focus {
          background-color: ${h n.nord0} !important;
          color: ${h n.nord4} !important;
          border-color: ${h n.nord3} !important;
        }

        menupopup {
          --panel-color: ${h n.nord4} !important;
          --panel-background: ${h n.nord1} !important;
          --panel-border-color: ${h n.nord3} !important;
        }

        menuitem:not([disabled]):hover {
          background-color: ${h n.nord2} !important;
          color: ${h n.nord6} !important;
        }
      '';
      userContent = ''
